...
const Test = () => {
  ...
  const overallMemoized = useMemo(() => {
    return chartone.overall || ''; 
  }, [chartone]);
  ...
  return (
    <div className='ml-auto mr-auto max-w-[1200px] mb-28'>
      <div className="testhead flex mt-14">
        ...
        <h1 className='text-2xl font-bold ml-4'>Билим тести</h1>
      ...
      <h1 className='text-center font-bold text-[#0956AF] text-2xl'>
        {overallMemoized} <br />
        <span className='bg-[#28A264] p-1.5 text-white font-bold pr-28'>Umumiy Natija</span>
      </h1>
    </div>
  );
};
